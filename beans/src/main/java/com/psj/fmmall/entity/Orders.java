...
public class Orders {
    ...
    /**
     * 收货人快照(快照用于防止后续用户改了地址后已完成订单地址变为修改后的地址)
     */
    ...
    /**
     * 获取收货人快照(快照用于防止后续用户改了地址后已完成订单地址变为修改后的地址)
     *
     * @return receiver_name - 收货人快照(快照用于防止后续用户改了地址后已完成订单地址变为修改后的地址)
     */
    ...
    /**
     * 设置收货人快照(快照用于防止后续用户改了地址后已完成订单地址变为修改后的地址)
     *
     * @param receiverName 收货人快照(快照用于防止后续用户改了地址后已完成订单地址变为修改后的地址)
     */
