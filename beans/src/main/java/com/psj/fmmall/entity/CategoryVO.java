...
/**
 * 1.Category类没有存储二级/三级分类的属性，所以创建CategoryVO类(比原来的Category多了categories属性而已)
 * 2.下面属性上的注解可以删除
 */
public class CategoryVO {
    ...
    // 因为一级下有两级,二级下有三级,所以存储的对象是CategoryVO不是Category
     ...
     * 获取口号 宣传标语
     *
     * @return category_slogan - 口号 宣传标语
     */
